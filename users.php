...
<body id="page-top">
	...
	<div id="wrapper">
		...
		<ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
			...
			<li class="nav-item">
				<a class="nav-link collapsed" href="print_all.php">
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<!-- Topbar Search -->
					<form method="post" class="d-none d-sm-inline-block form-inline mb-4 mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
						<div class="input-group">
							<input type="search" name="valueToSearh" placeholder="Search" class="form-control bg-light border-0 small">
							<div class="input-group-append">
								<button type="submit" class="btn btn-success" name="search" type="button">
									<i class="fas fa-search fa-sm"></i>
								</button>
							</div>
						</div>
